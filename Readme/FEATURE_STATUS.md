...
|---|---|---|
| Game design plan | ✅ Done | Stored in `Readme/GAME_DESIGN_PLAN.md` |
| Project folder structure | ✅ Done | Initial directories and placeholder modules created |
| Pygame window/game loop | ✅ Done | `core.game.Game` opens the window, caps FPS, handles quit/Escape, and draws HUD debug text |
